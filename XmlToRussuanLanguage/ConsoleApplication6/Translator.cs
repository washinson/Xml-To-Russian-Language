                ...
                if (File.Exists (outputFile)) {
                    ...
                    for(int i=0;i<text.Length-1;i++)
                    {
                        if (text[i] == '[' && text[i+1] == '\"')
                        {
                            ...
                            for (;i<text.Length;i++)
                            {
                                if (text[i] == '\"' && text[i + 1] == ',' && text[i + 2] == '\"') break;
                            }
                            translation += text.Substring(a, i-a);
                        }
                    }
                    ...
                    {   
                        if(translation[i]=='\\')
                        {
                            if (translation[i + 1] == '\n') 
                            {
                                translation = translation.Remove(i, 2);
                                translation = translation.Insert(i, "\n");
                                continue;
                            }
                            if (translation[i + 1] == '\"')
                            {
                            ...
                            if (translation[i + 1] == '\r')
                            {
                                translation = translation.Remove(i, 2);
                                translation = translation.Insert(i, "\r");
                                continue;
                            }
                            if (translation[i + 1] == '\b')
                            {
                                translation = translation.Remove(i, 2);
                                translation = translation.Insert(i, "\b");
                                continue;
                            }
                            if (translation[i + 1] == '\f')
                            {
                                translation = translation.Remove(i, 2);
                                translation = translation.Insert(i, "\f");
                                continue;
                            }
                            if (translation[i + 1] == '\t')
                            {
                            ...
                            {
                                translation = translation.Remove(i, 2);
                                translation = translation.Insert(i, "\0");
                                continue;
                            }
                            if (translation[i + 1] == '\v')
                            {
                                translation = translation.Remove(i, 2);
                                translation = translation.Insert(i, "\v");
                                continue;
                            }
                        }   
                    }
